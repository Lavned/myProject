...
public class ICOAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ICOAdapter(List<ICOBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public void updateList(List<ICOBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
