...
public class OTCAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<OTCBean> datas;
    ...
    public OTCAdapter(List<OTCBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderHolder) {
            ...
            final OTCBean item = datas.get(position -1);
    ...
    public void updateList(List<OTCBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
