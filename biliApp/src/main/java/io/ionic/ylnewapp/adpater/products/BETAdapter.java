...
public class BETAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BETAdapter(List<BETBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderHolder) {
           ...
           final BETBean item = datas.get(position-1);
    ...
    public void updateList(List<BETBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
