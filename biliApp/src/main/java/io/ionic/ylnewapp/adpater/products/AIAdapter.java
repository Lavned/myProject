...
public class AIAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AIAdapter(List<AIBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public void updateList(List<AIBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
