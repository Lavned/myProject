...
public class OneMainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<DIGBean> datas;
    ...
    public OneMainAdapter(List<DIGBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public void updateList(List<DIGBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
